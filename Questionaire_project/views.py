...
QUESTIONS = [
    ...
    {"id": 22, "scale": "depression", "scale_item_number": 21, "max_score": 3, "is_reverse_scored": False, "is_title_screen": False, "is_final": False, "question_text": "Loss of Interest in PhysicalActivity", "options": ["I have not noticed any recent change in my interest in physical activity.", "I am less interested in physical activity than I used to be.", "I have almost no interest in physical activity.", "I have lost interest in physical activity completely."]},
